...
def setup():
    ...
    <div class="col-md-6 offset-md-3">
        ...
        <h3 class="text-center">
            ...
            <a href="https://twitter.com/hindustanuni"><i class="fab fa-twitter fa-2x" aria-hidden="true"></i></a>&nbsp;
            <a href="https://www.facebook.com/Hindustan-University-208496942540382/"><i class="fab fa-facebook fa-2x" aria-hidden="true"></i></a>&nbsp;
            <a href="https://www.instagram.com/informationtechnologyhits/"><i class="fab fa-instagram fa-2x" aria-hidden="true"></i></a>
        </h3>
        <br>
